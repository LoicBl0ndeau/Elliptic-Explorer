...
export class ShortWeierstrass extends ModCurveGraph {
  ...
  showCurve() {
    this.calculator.setExpressions([
      // {id: "limit_{1}", latex: `z_{1}=1/12(-a_{1}^{2}-4a_{2})+\\left((-2a_{1}^{6}-24a_{1}^{4}a_{2}+72a_{1}^{3}a_{3}-96a_{1}^{2}a_{2}^{2}+144a_{1}^{2}a_{4}+\\sqrt{4(24(a_{1}a_{3}+2a_{4})-(a_{1}^{2}+4a_{2})^{2})^{3}+(-2a_{1}^{6}-24a_{1}^{4}a_{2}+72a_{1}^{3}a_{3}-96a_{1}^{2}a_{2}^{2}+144a_{1}^{2}a_{4}+288a_{1}a_{2}a_{3}-128a_{2}^{3}+576a_{2}a_{4}-432a_{3}^{2}-1728a_{6})^{2}}+288a_{1}a_{2}a_{3}-128a_{2}^{3}+576a_{2}a_{4}-432a_{3}^{2}-1728a_{6})^{\\frac{1}{3}}\\right)/(12\\cdot2^{1/3})-(24(a_{1}a_{3}+2a_{4})-(a_{1}^{2}+4a_{2})^{2})/(6\\cdot2^{2/3}(-2a_{1}^{6}-24a_{1}^{4}a_{2}+72a_{1}^{3}a_{3}-96a_{1}^{2}a_{2}^{2}+144a_{1}^{2}a_{4}+\\sqrt{4(24(a_{1}a_{3}+2a_{4})-(a_{1}^{2}+4a_{2})^{2})^{3}+(-2a_{1}^{6}-24a_{1}^{4}a_{2}+72a_{1}^{3}a_{3}-96a_{1}^{2}a_{2}^{2}+144a_{1}^{2}a_{4}+288a_{1}a_{2}a_{3}-128a_{2}^{3}+576a_{2}a_{4}-432a_{3}^{2}-1728a_{6})^{2}}+288a_{1}a_{2}a_{3}-128a_{2}^{3}+576a_{2}a_{4}-432a_{3}^{2}-1728a_{6})^{1/3})`},
      {id: 'courbe', latex: `y^2 = x^3 + ${this.param.a}*x + ${this.param.b} \\left\\{-${this.p/2}<x<${this.p/2}\\right\\} \\left\\{-${this.p/2}<y<${this.p/2}\\right\\}`, color:Graphic.Colors.point}
    ])
